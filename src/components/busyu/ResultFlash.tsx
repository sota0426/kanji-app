...
export default function ResultFlash({ visible, kanji, calcPoint }: ResultFlashProps) {
  ...
  return (
    <div className="text-center bg-green-100 rounded-lg p-3 mb-3 border-2 border-green-300">
      <div className="flex items-center justify-center space-x-2 mb-2">
        <Star className="text-yellow-500" size={24} />
        <span className="font-bold text-green-700">正解！</span>
        <Star className="text-yellow-500" size={24} />
      </div>
      <div className="text-2xl font-bold text-green-800 mb-2">{kanji.char}</div>
